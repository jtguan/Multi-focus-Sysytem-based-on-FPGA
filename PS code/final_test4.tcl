...
xilinx.com:hls:conv_transfer_1:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: conv_transfer_1_0, and set properties
  set conv_transfer_1_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:conv_transfer_1:1.0 conv_transfer_1_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins conv_transfer_1_0/in_data]
  ...
  connect_bd_intf_net -intf_net conv_transfer_1_0_out_data [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins conv_transfer_1_0/out_data]
